<template>
  ...
  >
    ...
    <form @submit.prevent="submitForm">
      ...
      >
        <span class="font-S-CoreDream-medium font-semibold text-xl mx-auto mb-8"
          >베이스</span
        >
      ...
      >
        ...
        <article class="flex mx-auto">
          <label
            v-for="(ingredientItem, index) in ingredients.slice(
              4,
              ingredient.length
            )"
            :key="ingredientItem.name"
      ...
      >
        <base-button mode="important" class="w-max px-4 py-2"
          >결과 확인하기</base-button
        >
      </section>
    </form>
