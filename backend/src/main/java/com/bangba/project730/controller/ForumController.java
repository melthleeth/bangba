...
public class ForumController {
	...
	public String createForum(@RequestBody @ApiParam(value = "자유게시판 하나에 대한 정보", required = true) ForumDto forumDto,
	...
	public List<ForumDto> searchForumList(Model model, @RequestParam(required = false, defaultValue = "1") int page_num,
	...
	@GetMapping("/{pk_forum}")
	public ForumDto detailForum(@PathVariable @ApiParam(value = "자유게시판 하나에 대한 상세정보", required = true) int pk_forum)
			throws Exception {
	...
	public String updateForum(@RequestBody @ApiParam(value = "자유게시판 하나에 대한 수정 정보", required = true) ForumDto forumDto,
			Model model) throws Exception {
		try {
	...
	public String deleteForum(@PathVariable @ApiParam(value = "자유게시판 하나 삭제", required = true) int pk_forum)
			throws Exception {
		try {
...
//		System.out.println(map.toString());
    ...
    @GetMapping("/comment/{pk_forum}")
    public Map<String,String> searchComment(@PathVariable int pk_forum , Model model) throws Exception {
        try {
